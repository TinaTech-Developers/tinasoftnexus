    ...
    <div className="bg-blue-100 py-10  h-full">
      <div className="flex flex-col items-center justify-center">
        <h1 className=" group md:mt-[80vh] text-center my-10 text-3xl uppercase ">
          ...
          <span class="block max-w-[25%] py-[2px] transition-all duration-500 h-0.5 bg-blue-700  translate-x-[180px] -translate-y-1"></span>
          <span class="block max-w-[13%] py-[2px] transition-all duration-500 h-0.5 bg-blue-400  translate-x-[270px] -translate-y-2"></span>
        </h1>
      </div>
...
function Service() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col w-80 h-full md:w-96 border  bg-transparent rounded-lg my-10 mx-auto text-gray-600 p-5 "
    >
